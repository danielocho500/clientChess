...
namespace Cliente.ChessService {
    ...
    public interface IFriendService {
        ...
        void Connected(int idUser);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IFriendService/Connected")]
        System.Threading.Tasks.Task ConnectedAsync(int idUser);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IFriendService/Disconnected")]
        void Disconnected(int idUser);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IFriendService/Disconnected")]
        System.Threading.Tasks.Task DisconnectedAsync(int idUser);
    }
    ...
    public partial class FriendServiceClient : System.ServiceModel.DuplexClientBase<Cliente.ChessService.IFriendService>, Cliente.ChessService.IFriendService {
        ...
        public void Connected(int idUser) {
            base.Channel.Connected(idUser);
        }
        
        public System.Threading.Tasks.Task ConnectedAsync(int idUser) {
            return base.Channel.ConnectedAsync(idUser);
        }
        
        public void Disconnected(int idUser) {
            base.Channel.Disconnected(idUser);
        }
        
        public System.Threading.Tasks.Task DisconnectedAsync(int idUser) {
            return base.Channel.DisconnectedAsync(idUser);
        }
    }
    ...
    public interface ISendInvitationService {
        ...
        void GenerateCodeInvitation(int idUser);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/ISendInvitationService/GenerateCodeInvitation")]
        System.Threading.Tasks.Task GenerateCodeInvitationAsync(int idUser);
        ...
        void ValidateCodeInvitation(int idUser, string code);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/ISendInvitationService/ValidateCodeInvitation")]
        System.Threading.Tasks.Task ValidateCodeInvitationAsync(int idUser, string code);
    ...
    public interface ISendInvitationServiceCallback {
        ...
        void ValidateCodeStatus(int status, string usernameRival, string username, string codeMatch, bool IsWhite);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/ISendInvitationService/JoinMatch")]
        void JoinMatch(string usernameRival, string username, string codeMatch, bool isWhite);
    }
    ...
    public partial class SendInvitationServiceClient : System.ServiceModel.DuplexClientBase<Cliente.ChessService.ISendInvitationService>, Cliente.ChessService.ISendInvitationService {
        ...
        public void GenerateCodeInvitation(int idUser) {
            base.Channel.GenerateCodeInvitation(idUser);
        }
        
        public System.Threading.Tasks.Task GenerateCodeInvitationAsync(int idUser) {
            return base.Channel.GenerateCodeInvitationAsync(idUser);
        }
        
        public void ValidateCodeInvitation(int idUser, string code) {
            base.Channel.ValidateCodeInvitation(idUser, code);
        }
        
        public System.Threading.Tasks.Task ValidateCodeInvitationAsync(int idUser, string code) {
            return base.Channel.ValidateCodeInvitationAsync(idUser, code);
        }
    ...
    public interface IGetStatsService {
        ...
        void GetStats(int idUser);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IGetStatsService/GetStats")]
        System.Threading.Tasks.Task GetStatsAsync(int idUser);
    }
    ...
    public interface IGetStatsServiceCallback {
        ...
        void ShowStats(int matchesplayed, int matchesWin, int eloMax, int eloActual);
    }
    ...
    public partial class GetStatsServiceClient : System.ServiceModel.DuplexClientBase<Cliente.ChessService.IGetStatsService>, Cliente.ChessService.IGetStatsService {
        ...
        public void GetStats(int idUser) {
            base.Channel.GetStats(idUser);
        }
        
        public System.Threading.Tasks.Task GetStatsAsync(int idUser) {
            return base.Channel.GetStatsAsync(idUser);
        }
    }
