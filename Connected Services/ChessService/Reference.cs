...
namespace Cliente.ChessService {
    ...
    public interface IMatchService {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IMatchService/SendMessage")]
        System.Threading.Tasks.Task SendMessageAsync(string message, string matchCode);
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IMatchService/sendConnection")]
        System.Threading.Tasks.Task sendConnectionAsync(bool white, string matchCode);
    }
    ...
    public partial class MatchServiceClient : System.ServiceModel.DuplexClientBase<Cliente.ChessService.IMatchService>, Cliente.ChessService.IMatchService {
        ...
        public void SendMessage(string message, string matchCode) {
            base.Channel.SendMessage(message, matchCode);
        }
        
        public System.Threading.Tasks.Task SendMessageAsync(string message, string matchCode) {
            return base.Channel.SendMessageAsync(message, matchCode);
        }
        
        public void sendConnection(bool white, string matchCode) {
            base.Channel.sendConnection(white, matchCode);
        }
        
        public System.Threading.Tasks.Task sendConnectionAsync(bool white, string matchCode) {
            return base.Channel.sendConnectionAsync(white, matchCode);
        }
    }
}
